...
| File | Description |
|------|-------------|
| `scripts/az_start.sh` | Azure container instance start script |
| `scripts/az_stop.sh` | Azure container instance stop script |
...
| File | Description |
|------|-------------|
| `terraform/provider.tf` | Terraform and Azure provider configuration, version requirements |
| `terraform/variables.tf` | Input variable definitions (resource group, location, app name, SKU, database URL) |
| `terraform/main.tf` | Main infrastructure resources (Resource Group, App Service Plan, Linux Web App) |
| `terraform/outputs.tf` | Output values (app URL, app name, resource group name) |
...
| `docs/adr/000-wow-these-seem-silly.md` | ADR: Commentary on ADR usage in portfolio projects |
...
| `docs/session_notes/feb_17.txt` | Session notes — Feb 17 |
| `docs/session_notes/feb_19.txt` | Session notes — Feb 19 (most recent) |
...
| File | Description |
|------|-------------|
| `docs/planning/README.md` | Planning directory overview |
| `docs/planning/PHASE2A_FIGHT_IMPLEMENTATION.md` | Implementation plan for Phase 2B Fight entity |
| `docs/planning/PHASE3_TAG_EXPANSION_DESIGN.md` | Phase 3 Tag Expansion design document |
| `docs/planning/PHASE4B_IAC_IMPLEMENTATION.md` | Phase 4B Infrastructure as Code implementation plan with Terraform |
| `docs/planning/archive/IMPLEMENTATION_PLAN_PHASE2.md` | Archived Phase 2 plan |
| `docs/planning/archive/NEXT_SESSION_*.md` | Archived session plans |
| `docs/planning/archive/SESSION_LOG_ARCHIVE.md` | Archived session logs from previous work |
